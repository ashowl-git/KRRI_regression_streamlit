...
def user_input_features():
    ...
    heat_recover_effectiveness = st.sidebar.slider('heat_recover_effectiveness', 0.8, 1.0, 0.7)
...
def user_input_features2():
    ...
    heat_recover_effectiveness_2 = st.sidebar.slider('heat_recover_effectiveness_2', 0.8, 1.0, 0.7)
...
df_result_merge.loc[cond1,'ALT_kW'] == 0
