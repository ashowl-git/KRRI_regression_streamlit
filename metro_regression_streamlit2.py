...
cond2 = df_concat2['index'] == 'Heating'
cond3 = df_concat2['index'] == 'DHW'
df_concat2.loc[cond2|cond3,'CO2_gas'] = df_concat2['kW'] * 0.3
df_concat2.loc[cond2|cond3,'CO2_Elec'] = df_concat2['kW'] * 0.7


cond4 = df_concat2['index'] == 'Room_Elec'
cond5 = df_concat2['index'] == 'Lighting'
cond6 = df_concat2['index'] == 'Fans'
cond7 = df_concat2['index'] == 'Pumps'
cond8 = df_concat2['index'] == 'Cooling'
df_concat2.loc[cond4|cond5|cond6|cond7|cond8,'CO2_Elec'] = df_concat2['kW']
